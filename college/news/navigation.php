<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="../../admin/admin_panal.php">College Box</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="../../admin/admin_panal.php">Home <span class="sr-only">(current)</span></a>
            </li>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="includenews.php">Include News</a>
                    <a class="dropdown-item" href="editnews.php">Edit News</a>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../../admin/show_complain.php">Show Complain</a>
            </li>
            <li class="nav-item">
        ...
        <form class="form-inline my-2 my-lg-0" action="../../admin/logout.php" method="POST">
