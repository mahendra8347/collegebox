...
if (isset($_POST['submit'])) {
    ...
    if (empty($my_option) || empty($my_option1)) {
        ...
        if (empty($err)) {
            $sql_e = "select username,password from master_admin where username='$username'";
...
<body>
    <div>
        <div class="text">
            <h1>Welcome To Admin Page of Your Website </h1>
        </div>
        <div class="text1">
            <h3>You Can Login Here</h3>
        </div>
        <div class="d-flex justify-content-center">
            <button id="button" type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">
                Login
            </button>
        </div>
