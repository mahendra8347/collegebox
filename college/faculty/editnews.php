    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tbody>
                ...
                $count = 1;
                if($department == 'IT'){
                $sel_query = "Select * from it_department_news ORDER by id desc";
                }elseif($department == 'CE'){
                    $sel_query = "Select * from ce_department_news ORDER by id desc";
                }
                ...
                if ($total_records == 0) { ?>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr>
                            ...
                            <td><?php echo substr($row["detail"], 0, 50); ?><a href="more_news_detail.php?id=<?php echo $row["id"]; ?>">Show More</a></td>
