...
<body>
    ...
    if (isset($_POST['new']) && $_POST['new'] == 1) {
        ...
        $department = $_SESSION['dep'];
        if ($department == 'IT') {
            $update = "update it_department_news set date ='" . $date . "',title='" . $title . "',detail='" . $detail . "' where id='" . $id . "'";
        }elseif($department == 'CE'){
            $update = "update ce_department_news set date ='" . $date . "',title='" . $title . "',detail='" . $detail . "' where id='" . $id . "'";
        }
